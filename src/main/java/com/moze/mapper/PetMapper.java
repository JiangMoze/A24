package com.moze.mapper;

import com.moze.model.Item;
import com.moze.model.Product;
...
public interface PetMapper {//操作宠物的dao
    ...
    @Results({
            ...
            @Result(column="catid", property="category",
                    one = @One(select = "com.moze.mapper.CategoryMapper.queryCategoryByid")),
    })
    ...
    @Results({
            ...
            @Result(column="productid", property="product",
                    one = @One(select = "com.moze.mapper.ProductMapper.queryProductByid")),
    })
